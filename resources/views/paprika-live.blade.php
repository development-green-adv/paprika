                        ...
                        <div class="col-12 col-md-9 menu_show_item">
                            ...
                            <div class="row">
                                <div class="col-12" style="border-bottom: 3px solid #212121; padding-bottom: 10px;">
                                    <h4 style="color: #fff;"><span style="margin-right: 15px;"><img src="{{ asset('images/web/paprika-live.png') }}" alt="Paprika live"></span> Paprika live</h4>
                                </div>

                                <div class="col-12 col-md-12" style="padding-top: 40px;">
                                    <iframe src="http://g0.ipcamlive.com/player/player.php?alias=5de4e89619411" width="100%" height="550px" 
